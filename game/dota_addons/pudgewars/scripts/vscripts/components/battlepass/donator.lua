function Battlepass:DonatorCompanion(ID, unit_name, js)
	...
	if DONATOR_CUSTOM_COMPANION and DONATOR_CUSTOM_COMPANION[tostring(PlayerResource:GetSteamID(ID))] and not js then 
		unit_name = DONATOR_CUSTOM_COMPANION[tostring(PlayerResource:GetSteamID(ID))]
	end
