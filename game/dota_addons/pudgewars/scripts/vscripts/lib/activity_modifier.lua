...
LinkLuaModifier(
    ...
    "lib/modifiers/modifier_attack_speed_activity.lua",
    LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
    "modifier_movement_speed_activity",
    "lib/modifiers/modifier_movement_speed_activity.lua",
    LUA_MODIFIER_MOTION_NONE
)
LinkLuaModifier(
    "modifier_attack_range_activity",
    "lib/modifiers/modifier_attack_range_activity.lua",
    LUA_MODIFIER_MOTION_NONE
)

LinkLuaModifier("modifier_activity0", "lib/modifiers/modifier_activity0.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity1", "lib/modifiers/modifier_activity1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity2", "lib/modifiers/modifier_activity2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity3", "lib/modifiers/modifier_activity3.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity4", "lib/modifiers/modifier_activity4.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity5", "lib/modifiers/modifier_activity5.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity6", "lib/modifiers/modifier_activity6.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity7", "lib/modifiers/modifier_activity7.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity8", "lib/modifiers/modifier_activity8.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity9", "lib/modifiers/modifier_activity9.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity10", "lib/modifiers/modifier_activity10.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity11", "lib/modifiers/modifier_activity11.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity12", "lib/modifiers/modifier_activity12.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity13", "lib/modifiers/modifier_activity13.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity14", "lib/modifiers/modifier_activity14.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity15", "lib/modifiers/modifier_activity15.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity16", "lib/modifiers/modifier_activity16.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity17", "lib/modifiers/modifier_activity17.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity18", "lib/modifiers/modifier_activity18.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity19", "lib/modifiers/modifier_activity19.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_activity20", "lib/modifiers/modifier_activity20.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_battlepass_wearable_spellicons", "lib/modifiers/modifier_battlepass_wearable_spellicons.lua", LUA_MODIFIER_MOTION_NONE)
